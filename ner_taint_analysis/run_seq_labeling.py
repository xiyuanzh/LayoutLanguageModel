...
def main():  # noqa C901
    ...
    parser.add_argument(
        "--train_taint_probability", type=float, default=0.1, help="random seed for initialization"
    )
    parser.add_argument(
        "--test_taint_probability", type=float, default=0.1, help="random seed for initialization"
    )
    parser.add_argument(
        "--train_taint_seed", type=int, default=42, help="random seed for initialization"
    )
    parser.add_argument(
        "--test_taint_seed", type=int, default=42, help="random seed for initialization"
    )
